...
color.closest_lab = function(target, relative) {
    var key = color.lab_palette_map_key(target);
    var result = color.map_palette_lab([target], relative, 'closest');
...
color.furthest_lab = function(target, relative) {
    var key = color.lab_palette_map_key(target);
    var result = color.map_palette_lab([target], relative, 'furthest');
